  ...
  discover: () => [
    {
      ...
      controls: [
        { id: "c-verify", kind: "verifier", label: "Deterministic coverage-ratio verification", strength: "deterministic", satisfies: [{ framework: "mas-ai-rg", clause: "monitoring" }, { framework: "eu-ai-act", clause: "art15" }, { framework: "nist-ai-rmf", clause: "measure" }, { framework: "frontier-ai-rmf", clause: "risk-evaluation" }, { framework: "gp-agent-l1-l5", clause: "level-matched-safeguards" }] },
        { id: "c-approval", kind: "human-oversight", label: "Authenticated human approval before release", strength: "deterministic", satisfies: [{ framework: "eu-ai-act", clause: "art14" }, { framework: "sg-mgf", clause: "human-accountability" }, { framework: "frontier-ai-rmf", clause: "risk-governance" }, { framework: "gp-agent-l1-l5", clause: "loss-of-oversight" }] },
        ...
        { id: "c-recency", kind: "guardrail", label: "Data-recency ≤ 24 months", strength: "deterministic", satisfies: [{ framework: "mas-ai-rg", clause: "development" }, { framework: "frontier-ai-rmf", clause: "risk-identification" }] },
        ...
        { id: "c-fin-scope", kind: "guardrail", label: "Financial scope boundary", strength: "deterministic", satisfies: [{ framework: "mas-safr", clause: "scope-mandate" }, { framework: "frontier-ai-rmf", clause: "high-privilege-env" }] },
        ...
        { id: "c-budget", kind: "containment", label: "Per-run token/cost budget (runaway-loop containment)", strength: "deterministic", satisfies: [{ framework: "frontier-ai-rmf", clause: "risk-thresholds" }], capabilities: ["budget-cap"] },
      ],
